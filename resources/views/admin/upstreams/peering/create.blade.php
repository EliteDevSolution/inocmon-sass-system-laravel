    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box p-1">
                <div class="card-body">
                    <h2 class="header-title text-blue text-center">Novo peering</h2>
                    <div class="row">
                        <div class="col-md-4">
                            <label class="mb-1 font-weight-bold text-muted">ID do peering</label>
                            ...
                            <label class="mb-1 font-weight-bold text-muted">PoP de de acesso</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" data-toggle="select2">
                                ...
                                <option>SW3-PE-SIS-DTC1-01</option>
                            </select>
                        </div>
