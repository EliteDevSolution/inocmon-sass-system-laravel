                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Novo Transio Ip</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Novo Transio Ip</h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card-box p-1">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label class="mb-1 font-weight-bold text-muted">ID do transito</label>
